...
///
/// IMPORTANT: this engine has no costume/sprite-switching system — Turtu
...
final cqLooksSoundLessons = <Lesson>[
  ...
  Lesson(
    ...
    glyph: '✨',
    complexity: 1,
    target: 'Make Turtu hide, then come back with show.',
  ...
  Lesson(
    ...
    glyph: '🔊',
    complexity: 1,
    target: 'Make Turtu play a sound.',
  ...
  Lesson(
    ...
    glyph: '🤐',
    complexity: 1,
    target: 'Hide Turtu, then have it say something anyway.',
  ...
  Lesson(
    ...
    glyph: '🌟',
    complexity: 1,
    target: 'Show Turtu, then have it say something proud.',
  ...
  Lesson(
    ...
    glyph: '🎬',
    complexity: 1,
    target: 'Play a sound, then reveal Turtu with show.',
  ...
  Lesson(
    ...
    glyph: '🕶️',
    complexity: 1,
    target: 'Hide Turtu, then play a sound as a sneaky signal.',
  ...
  Lesson(
    ...
    glyph: '🎯',
    complexity: 2,
    target: 'Move Turtu, then play a sound to mark the landing.',
  ...
  Lesson(
    ...
    glyph: '🚀',
    complexity: 2,
    target: 'Move Turtu, then have it announce where it went.',
  ...
  Lesson(
    ...
    glyph: '🔄',
    complexity: 2,
    target: 'Turn Turtu, then have it say something about the new direction.',
  ...
  Lesson(
    ...
    glyph: '🚶‍♂️',
    complexity: 3,
    target: 'Give Turtu a walk-cycle feel with move+wait inside a repeat.',
  ...
  Lesson(
    ...
    glyph: '♾️',
    complexity: 4,
    target: 'Make Turtu blink forever: hide, wait, show, wait, repeating.',
