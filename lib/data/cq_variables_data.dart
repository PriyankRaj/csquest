...
final cqVariablesLessons = <Lesson>[
  ...
  Lesson(
    ...
    glyph: '❤️',
    complexity: 1,
    target: 'Set Score to 3 to represent three lives, then show Process.',
  ...
  Lesson(
    ...
    glyph: '🎳',
    complexity: 1,
    target: 'Set Score to 50, then move Process forward.',
  ...
  Lesson(
    ...
    glyph: '🏁',
    complexity: 1,
    target: 'Set Score to 0 and send Process back to the center.',
  ...
  Lesson(
    ...
    glyph: '↻',
    complexity: 1,
    target: 'Set Score to 7, then turn Process to face a new way.',
  ...
  Lesson(
    ...
    glyph: '👻',
    complexity: 1,
    target: 'Set Score to 9, then hide and show Process again.',
  ...
  Lesson(
    ...
    glyph: '🔄',
    complexity: 3,
    target: 'Add 2 points twice (net +4), then turn Process around.',
