                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 24,
                        backgroundColor: QuestColors.panel2,
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                if (!s.available)
                                  Container(
                                    ...
                                    child: const Text('Coming soon', style: TextStyle(fontSize: 10.5, color: QuestColors.textDim)),
                                  ),
                              ],
                            ),
                            ...
                            Text(
                              ...
                              maxLines: 2,
                              overflow: TextOverflow.ellipsis,
                              style: const TextStyle(fontSize: 12.5, color: QuestColors.textDim),
                            ),
                          ],
                        ),
                      ),
                      if (s.available) const Icon(Icons.chevron_right, color: QuestColors.textDim),
                    ],
                  ),
                ),
              ),
