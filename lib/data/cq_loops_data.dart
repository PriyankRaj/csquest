...
final cqLoopsLessons = <Lesson>[
  ...
  Lesson(
    ...
    glyph: '🔁',
    complexity: 1,
    target: 'Use a repeat block so Turtu moves forward 4 times without four separate move blocks.',
    narrator: 'Turtu: My wheels get tired tapping the same block four times — teach me to repeat!',
    steps: const [
  ...
  Lesson(
    ...
    glyph: '↻',
    complexity: 1,
    target: 'Add a turn block inside the repeat so Turtu turns after every move.',
  ...
  Lesson(
    ...
    glyph: '💬',
    complexity: 1,
    target: 'After drawing your square, make Turtu announce it with a say block.',
  ...
  Lesson(
    ...
    glyph: '📍',
    complexity: 3,
    target: "Use 'go to x y' to reset Turtu's position, then draw a square from there.",
  ...
  Lesson(
    ...
    glyph: '🧭',
    complexity: 3,
    target: 'Point Turtu in a chosen direction before drawing a pentagon.',
  ...
  Lesson(
    ...
    glyph: '🫥',
    complexity: 3,
    target: 'Hide Turtu while repositioning, then show it again right before drawing.',
  ...
  Lesson(
    ...
    glyph: '🏓',
    complexity: 3,
    target: "Add 'if on edge, bounce' inside your forever-square loop so Turtu never rolls off the map.",
  ...
  Lesson(
    ...
    glyph: '💫',
    complexity: 4,
    target: 'Draw two 5-pointed stars, reorienting Turtu between them.',
  ...
  Lesson(
    ...
    glyph: '🧭',
    complexity: 5,
    target: 'Point Turtu in a direction before growing the six-petal square flower.',
