...
final cqBlockDefs = <String, BlockDef>{
  ...
  'motion_move_steps': const BlockDef(
    ...
    category: 'motion',
    params: [BlockParam('steps', 'steps', 10)],
  ),
  'motion_turn_right': const BlockDef(
    ...
    color: QuestColors.cqMotion,
    category: 'motion',
    params: [BlockParam('degrees', 'degrees', 15)],
  ),
  ...
  'motion_point_direction': const BlockDef(
    ...
    color: QuestColors.cqMotion,
    category: 'motion',
    params: [BlockParam('degrees', 'degrees', 90)],
  ),
  'motion_change_x': const BlockDef(
    ...
    color: QuestColors.cqMotion,
    category: 'motion',
    params: [BlockParam('amount', 'amount', 10)],
  ),
  ...
  'motion_goto_xy': const BlockDef(
    ...
    color: QuestColors.cqMotion,
    category: 'motion',
    params: [BlockParam('x', 'x', 0), BlockParam('y', 'y', 0)],
  ),
  ...
  'control_repeat': const BlockDef(
    ...
    color: QuestColors.cqControl,
    category: 'control',
    params: [BlockParam('times', 'times', 4)],
    isContainer: true,
  ),
  'control_wait': const BlockDef(
    ...
    color: QuestColors.cqControl,
    category: 'control',
    params: [BlockParam('seconds', 'seconds', 1)],
  ),
  ...
  'looks_say': const BlockDef(
    ...
    color: _looksColor,
    category: 'looks',
    params: [BlockParam('text', 'text', 'Hello!', kind: BlockParamKind.text)],
  ),
  ...
  'variables_set': const BlockDef(
    ...
    color: _varColor,
    category: 'variables',
    params: [BlockParam('value', 'value', 0)],
  ),
  'variables_change': const BlockDef(
    ...
    color: _varColor,
    category: 'variables',
    params: [BlockParam('value', 'value', 1)],
  ),
};
