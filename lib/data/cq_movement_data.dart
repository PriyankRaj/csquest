...
final cqMovementLessons = <Lesson>[
  Lesson(
    ...
    glyph: '🚶',
    complexity: 1,
    target: 'Make Process move when you tap Run.',
  ...
  Lesson(
    ...
    glyph: '↻',
    complexity: 1,
    target: 'Move forward, then turn — see Process change direction.',
  ...
  Lesson(
    ...
    glyph: '🧭',
    complexity: 1,
    target: 'Make Process face an exact direction before it moves.',
  ...
  Lesson(
    ...
    glyph: '↔️',
    complexity: 2,
    target: 'Move Process diagonally using change x and change y together.',
  ...
  Lesson(
    ...
    glyph: '🏓',
    complexity: 2,
    target: 'Keep Process moving forever, bouncing cleanly off every edge.',
  ...
  Lesson(
    ...
    glyph: '🔄',
    complexity: 1,
    target: 'Make Process whip around with a big turn.',
  ...
  Lesson(
    ...
    glyph: '↺',
    complexity: 1,
    target: 'Turn Process the other way, sharply.',
  ...
  Lesson(
    ...
    glyph: '👀',
    complexity: 1,
    target: 'Show Process, then hide it again.',
  ...
  Lesson(
    ...
    glyph: '🔊',
    complexity: 2,
    target: 'Play a click sound and move Process.',
  ...
  Lesson(
    ...
    glyph: '⏳',
    complexity: 2,
    target: 'Make Process pause, then move.',
  ...
  Lesson(
    ...
    glyph: '🌀',
    complexity: 2,
    target: 'Send Process to an exact spot on the stage.',
  ...
  Lesson(
    ...
    glyph: '🧭',
    complexity: 2,
    target: 'Point Process in a direction, then move that way.',
  ...
  Lesson(
    ...
    glyph: '🔁',
    complexity: 2,
    target: 'Move Process several times using a repeat loop.',
  ...
  Lesson(
    ...
    glyph: '🌪️',
    complexity: 2,
    target: 'Turn Process several times using a repeat loop.',
  ...
  Lesson(
    ...
    glyph: '♾️',
    complexity: 2,
    target: 'Keep Process moving forever, non-stop.',
  ...
  Lesson(
    ...
    glyph: '🌀',
    complexity: 2,
    target: 'Keep Process turning forever.',
  ...
  Lesson(
    ...
    glyph: '🗣️',
    complexity: 2,
    target: "Make Process say something, then move, inside a loop.",
  ...
  Lesson(
    ...
    glyph: '🚧',
    complexity: 3,
    target: 'Do something special only when Process reaches the edge.',
  ...
  Lesson(
    ...
    glyph: '🎭',
    complexity: 3,
    target: 'Show, say, then hide Process, on a loop.',
  ...
  Lesson(
    ...
    glyph: '✨',
    complexity: 3,
    target: 'Teleport Process repeatedly using a loop.',
  ...
  Lesson(
    ...
    glyph: '📢',
    complexity: 3,
    target: 'Announce it out loud when Process hits the edge.',
  ...
  Lesson(
    ...
    glyph: '🐢',
    complexity: 4,
    target: "Move forever, and say something whenever Process hits the edge.",
  ...
  Lesson(
    ...
    glyph: '👻',
    complexity: 4,
    target: 'Blink Process — show, wait, hide, wait — on a loop.',
  ...
  Lesson(
    ...
    glyph: '🛡️',
    complexity: 5,
    target: "When Process hits the edge, turn AND announce it, forever.",
