...
final cqComboTalkingLessons = <Lesson>[
  Lesson(
    ...
    glyph: '💬',
    complexity: 1,
    target: 'Make Turtu say a line out loud.',
  ...
  Lesson(
    ...
    glyph: '🎬',
    complexity: 1,
    target: 'Give Turtu two different lines to say, one after another.',
  ...
  Lesson(
    ...
    glyph: '🚶',
    complexity: 2,
    target: 'Make Turtu narrate while it moves.',
  ...
  Lesson(
    ...
    glyph: '🎭',
    complexity: 1,
    target: 'Show Turtu on stage, then have it speak.',
  ...
  Lesson(
    ...
    glyph: '🧭',
    complexity: 2,
    target: 'Turn Turtu to face someone, walk toward them, then speak.',
  ...
  Lesson(
    ...
    glyph: '👻',
    complexity: 2,
    target: 'Hide Turtu, wait, then show it again with a line.',
  ...
  Lesson(
    ...
    glyph: '🌄',
    complexity: 2,
    target: 'Jump Turtu to a new spot, then announce the new scene.',
  ...
  Lesson(
    ...
    glyph: '👥',
    complexity: 2,
    target: 'Turn Turtu one way to say a line, then turn the other way to reply.',
